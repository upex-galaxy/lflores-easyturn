...
- Código del proyecto en Jira: ESYTRN
...
### EPIC 1: [Epic Title]
**Planned Jira Key:** [PROYECTO]
**Priority:** CRITICAL | HIGH | MEDIUM | LOW
**Description:** [1-2 líneas]

**User Stories (estimado: X):**
1. [PROYECTO] - As a [user], I want to [action] so that [benefit]
2. [PROYECTO] - As a [user], I want to [action] so that [benefit]
...
